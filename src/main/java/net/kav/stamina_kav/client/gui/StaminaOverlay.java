package net.kav.stamina_kav.client.gui;
...
public class StaminaOverlay
    ...
    private static final Identifier Stamina_StartFull= new Identifier(Stamina.MOD_ID,"textures/gui/stamina/stamina_full.png");
    private static final Identifier Stamina_StartEmpty= new Identifier(Stamina.MOD_ID,"textures/gui/stamina/stamina_empty.png");
    ...
    {
        float stamina = StaminaData.Stamina(((IEntityDataSaver) client.player));
        ...
        if(!(client.player.isCreative())&&!(client.player.isSpectator()))
        {
            ...
            {
                y22=10+10*(i+1);
                this.draw(Stamina_StartEmpty, matrixStack, x, y, initialx-10-10*i, 50,5);
            }

            int z;
            if(number_of_bars==1)
            {
                this.draw(Stamina_StartEmpty, matrixStack, x, y, initialx-y22, 50,10);

            }
            else if(number_of_bars==2)
            {
                this.draw(Stamina_StartEmpty, matrixStack, x, y, initialx-y22, 50,15);
            }
            else if(number_of_bars==3)
            {
                this.draw(Stamina_StartEmpty, matrixStack, x, y, initialx-y22, 50,20);
            }
            else if(number_of_bars==4)
            {
                this.draw(Stamina_StartEmpty, matrixStack, x, y, initialx-y22, 50,25);
            }
            else if(number_of_bars==0)
            {
                this.draw(Stamina_StartEmpty, matrixStack, x, y, initialx-y22, 50,30);
            }
            ...
            //Draw full stamina
            this.draw(Stamina_StartFull, matrixStack, x, y, initialx, 50,0,x23);
            ...
            for (int i = 0; i < number_of_bar - 2; i++) {
                ...
                this.draw(Stamina_StartFull, matrixStack, x, y, initialx-10-10*i, 50,5,x23);
            ...
            if (number_of_bars == 1) {
                this.draw(Stamina_StartFull, matrixStack, x, y, initialx-y22, 50,10,x23-7);

            } else if (number_of_bars == 2) {
                this.draw(Stamina_StartFull, matrixStack, x, y, initialx-y22, 50,15,x23-5);
            } else if (number_of_bars == 3) {
                this.draw(Stamina_StartFull, matrixStack, x, y, initialx-y22, 50,20,x23-4);

            } else if (number_of_bars == 4) {
                this.draw(Stamina_StartFull, matrixStack, x, y, initialx-y22, 50,25,x23-2);
            } else  {
                this.draw(Stamina_StartFull, matrixStack, x, y, initialx-y22, 50,30,x23);
            }
